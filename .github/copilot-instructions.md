...
6. Enforce strict version pinning for this repository state. Use ManulEngine 0.0.9.28 exactly when writing installation commands, and keep shared version guards synchronized with that runtime pin unless explicitly changed by the user.
